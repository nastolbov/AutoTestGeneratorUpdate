...
body("На логическом уровне для каждой сущности фиксируется состав атрибутов с указанием их "
     "назначения (описания) и роли ключа — без привязки к конкретным типам SQLite, ограничениям и "
     "индексам, которые задаются в физической модели. Имена атрибутов соответствуют полям реальной "
     "базы данных. Состав атрибутов сущностей логической модели приведён в таблице 34.")
