...
body("После запуска система переходит в состояние «Ожидание ввода», в котором пользователь задаёт "
     ...
     "автотесты» система переходит в состояние «Выполнение тестов» и запускает все сгенерированные "
     "тесты командой mvn test с потоковым выводом хода прогона. По завершении прогона результаты "
...
figure("ris_12_state_transition.png", "Рис. 12. Диаграмма переходов состояний", 15.5)
