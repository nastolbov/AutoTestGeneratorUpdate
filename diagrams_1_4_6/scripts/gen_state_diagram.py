...
EDGES = [
    ...
    ([(cx("S3"), bot("S3")), (cx("S4"), top("S4"))],
     "запустить автотесты", (cx("S3") - 18, 522), 'r'),
    ...
    ([(left("S6"), 814), (right("S5"), 814)],
     "просмотр результатов теста", ((right("S5") + left("S6")) / 2, 828), 'c'),
]
...
DE = [
    ...
    ("S3", "S4", "запустить автотесты", (0.5, 1), (0.5, 0)),
    ...
    ("S6", "S5", "просмотр результатов теста", (0, 0.84), (1, 0.84)),
]
eid = 0
