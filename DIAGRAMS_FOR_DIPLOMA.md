...
> Краткая спецификация модулей в основном тексте, подробная — в Прил. 2 (текст программы) и Прил. 3 (спецификация модулей). См. `TABLES_vers2.md` §4.4 — там **41 модуль** (= 41 `.java`-файл — без внутренних классов) с входными/выходными параметрами.
