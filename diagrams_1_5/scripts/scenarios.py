    ...
    "ui": {
        ...
        "flows": {
            "normal": [
                ...
                ("ctrl", EDGE, "отображение таблицы", "ret"),
            ],
            "user": [
                (EDGE, "ctrl", "onSelectXml()", "call"),
                ("ctrl", "ctrl", "открыть диалог выбора файла", "self"),
                (EDGE, "ctrl", "Отмена", "call"),
                ("ctrl", EDGE, "файл не выбран, разбор не выполняется", "ret"),
            ],
            "system": [
                (EDGE, "ctrl", "onParse()", "call"),
                ("ctrl", "xmlp", "parse(файл)", "call"),
                ("xmlp", "exc", "ошибка разбора XML", "create"),
                ("xmlp", "ctrl", "ParserException", "ret"),
                ("ctrl", "ctrl", "showAlert(сообщение)", "self"),
                ("ctrl", EDGE, "сообщение об ошибке", "ret"),
            ],
        },
    },
    "parser": {
